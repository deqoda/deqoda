                    ...
                    <div class="col-md-8 col-md-offset-2">
                       <div class="widget">
                            <div class="custom-module">
                                <h4 class="module-title"><i class="material-icons"></i> Help us build our base.</h4>

                                <div class="panel panel-primary">
                                    <div class="panel-body">
                                        <form class="sidebar-login" name="slanje" action="https://formspree.io/deqoda@deqoda.com"
                                          method="POST">
                                         <input type="text" class="form-control" id="ime" name="name" placeholder="Your name">    
                                          <input name="email" class="form-control" placeholder="Your email" type="email" required>
                                          <textarea name="message" class="form-control" rows="8" id="textArea" placeholder="Paste your code" required></textarea>
                                          <button type="submit"class="btn btn-raised btn-info gr" id="senda">Send</button>
                                    </form> 
