...
<!-- /Yandex.Metrika counter -->
    ...
    <![endif]-->
     <meta name="description" content="Awesome snippets for common jQuery use cases.">
    <meta name="keywords" content="snippets, jquery, deqoda, useful, function">
    <script>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                                ...
                                <div class="topic-desc row-fluid clearfix">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="blog-meta clearfix">
                                            ...
                                            <small><?php echo $page->datum; ?></small>
                                            
                                        </div>

                                      <div class="centar">
                                       
                                        <pre><code class="javascript"><?php echo $page->kod; ?></code></pre>
                                        
                                       
                                 
                                        
                                        <pre class="output"><?php echo $page->putica; ?>
                        ...
                        <?php foreach ( $pages->find('template=single, sort=-created, limit=1') as $single ):?> 
                        <aside class="topic-page topic-list blog-list forum-list single-forum">
                            <article class="well btn-group-sm clearfix">
                                <div class="topic-desc row-fluid clearfix">
