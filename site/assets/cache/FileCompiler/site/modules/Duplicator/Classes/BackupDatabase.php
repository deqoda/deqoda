...
class BackupDatabase
{
    ...
    public function getZip()
    {
        ...
        $result = \ProcessWire\wirezipfile($zipfile, $sqlfile);
    ...
    {
        $backup = new \ProcessWire\WireDatabaseBackup($this->options['path']);
        $backup->setDatabase($this->database);
        $backup->setDatabaseConfig(\ProcessWire\wire('config'));
