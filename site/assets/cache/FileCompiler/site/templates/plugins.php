                ...
                <div class="row">
                    <div class="content col-md-8 col-md-offset-2">
                        <div class="welcome-text text-center">
                            <h1> <strong>Awesome jQuery plugins</strong> </h1>
                ...
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        <div class="topic_top row clearfix">
                         ...
                         <?php foreach ( $pages->find('template=plugins, sort=-created') as $plugins ):?> 
                                                ...
                                                <article class="well btn-group-sm clearfix">
                                                    ...
                                                    <div class="panel-heading" role="tab" id="headingOne">
                                                        <div class="panel-title">
                                                            <a role="button" data-toggle="collapse" data-parent="#accordion" href="#<?=$plugins->hrefica?>" aria-expanded="true" aria-controls="collapseOne">
