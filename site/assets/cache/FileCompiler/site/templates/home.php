...
<head>
    ...
    <!-- Site Metas -->
    <title>Deqoda - useful jQuery snippets</title>
    <script>
  ...
  $("title").text("Don't forget to read this..." + pageTitle);
    ...
    <link rel="stylesheet" href="<?php echo $config->urls->templates; ?>styles/tomorrow-night-bright.css">
<script src="<?php echo $config->urls->templates; ?>js/highlight.pack.js"></script>
<script>hljs.initHighlightingOnLoad();</script>
<script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-5a606a314975015d"></script>
    <!-- Bootstrap CSS -->
...
<body class="home_alt">
                ...
                <div class="row">
                    <div class="content col-md-8 col-md-offset-2">
                        <div class="welcome-text text-center">
                            <h1> <strong>Awesome snippets for common jQuery use cases</strong> </h1>
 ...
 <input type="text" id="autocomplete" name="asd" placeholder="Search for jQuery..."  class=" form-control" /> 
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        ...
                        <?php foreach ( $pages->find('template=single, sort=-random, limit=10') as $single ):?> 
                            ...
                            <article class="well btn-group-sm clearfix">
                                <div class="topic-desc row-fluid clearfix">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <pre><code class="javascript"> <?=$single->kod;?></code></pre>
                                        
                                        <div class="output"> <?=$single->putica?>
</div>
    ...
    $("input#autocomplete").autocomplete({
        source: [
            ...
            <?php foreach ( $pages->find('template=single, sort=-created') as $single ):?>
             { value: "<?=$single->title?>", url: '<?=$single->httpUrl?>' }, 
             <? endforeach; ?>
        ],
